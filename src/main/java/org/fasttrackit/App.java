...
dog.jumping();
        ...
        Pet cat = new Cat("Kitty", 8, 3, 7);
        ((Cat) cat).hairAccesorise = "bow clips";
        ...
        System.out.println(((Cat) cat).hairAccesorise);
